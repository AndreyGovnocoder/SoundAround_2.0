...
public:
    ...
    void setupUi(QDialog *TrackDialog)
    {
        ...
        addFile_btn->setMinimumSize(QSize(30, 30));
        addFile_btn->setMaximumSize(QSize(30, 30));
        addFile_btn->setAcceptDrops(true);
        addFile_btn->setStyleSheet(QString::fromUtf8("QToolButton \n"
"{\n"
...
" }"));
        ...
        addFile_btn->setIconSize(QSize(20, 20));
...
"}"));
        ...
        addTagToTrack_btn->setStyleSheet(QString::fromUtf8("QToolButton \n"
"{\n"
...
" }"));
        ...
        addTagToTrack_btn->setIconSize(QSize(22, 22));
        ...
        addTagToAllTags_btn->setStyleSheet(QString::fromUtf8("QToolButton \n"
"{\n"
"     border: 0px outset #8f8f91;\n"
"	 border-color: rgb(0, 128, 0);\n"
"     border-radius: 6px;\n"
...
" }"));
        ...
        addTagToAllTags_btn->setIconSize(QSize(22, 22));
