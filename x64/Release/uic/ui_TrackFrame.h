...
"                                 stop: 0 #e1ffde, stop: 0.4 #c5ffbb,\n"
"                                 stop: 0.5 #a7ffa1, stop: 1.0 #80c37b);\n"
"}\n"
"\n"
"QComboBox:!editable:on, QComboBox::drop-down:editable:on \n"
"{\n"
"    background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,\n"
"                                stop: 0 #80c37b, stop: 0.4 #a7ffa1,\n"
"                                stop: 0.5 #c5ffbb, stop: 1.0 #e1ffde);\n"
"}\n"
"\n"
"QComboBox:on \n"
"{ \n"
...
"}"));
        ...
        close_btn->setMinimumSize(QSize(0, 0));
        close_btn->setMaximumSize(QSize(20, 20));
        close_btn->setStyleSheet(QString::fromUtf8("QToolButton \n"
"{\n"
"     border: 0px outset #8f8f91;\n"
"	 border-color: rgb(0, 128, 0);\n"
"     border-radius: 4px;\n"
...
"                                       stop: 0 rgba(218, 219, 222, 50), stop: 1 rgba(246, 247, 250, 50););\n"
" border: 0px ;\n"
" }\n"
"\n"
" QToolButton:flat \n"
...
""));
        ...
        stop_btn->setStyleSheet(QString::fromUtf8("QToolButton \n"
"{\n"
"     border: 0px outset #8f8f91;\n"
"	 border-color: rgb(0, 128, 0);\n"
"     border-radius: 6px;\n"
...
" }"));
        ...
        sizePolicy3.setHeightForWidth(playPause_btn->sizePolicy().hasHeightForWidth());
        playPause_btn->setSizePolicy(sizePolicy3);
        playPause_btn->setMinimumSize(QSize(30, 30));
        playPause_btn->setMaximumSize(QSize(30, 30));
        playPause_btn->setStyleSheet(QString::fromUtf8("QToolButton \n"
"{\n"
"     border: 0px outset #8f8f91;\n"
"	 border-color: rgb(0, 128, 0);\n"
"     border-radius: 6px;\n"
...
" }"));
        ...
        loopBtn->setStyleSheet(QString::fromUtf8("\n"
"QToolButton:hover \n"
"{\n"
"	 border: 1px outset #8f8f91;\n"
"border-radius: 5px;\n"
...
""));
        ...
        QPalette palette3;
        QBrush brush(QColor(240, 255, 240, 255));
...
"}"));
        ...
        sizePolicy3.setHeightForWidth(sliderVolume->sizePolicy().hasHeightForWidth());
        sliderVolume->setSizePolicy(sizePolicy3);
        ...
        muteBtn->setStyleSheet(QString::fromUtf8("QToolButton \n"
"{\n"
"     border: 0px outset #8f8f91;\n"
"	 border-color: rgb(0, 128, 0);\n"
"     border-radius: 6px;\n"
...
" }"));
        ...
        sizePolicy4.setHeightForWidth(volumeValueLbl->sizePolicy().hasHeightForWidth());
        volumeValueLbl->setSizePolicy(sizePolicy4);
